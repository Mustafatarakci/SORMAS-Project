...
Feature: Case import and export tests
  ...
  Scenario: Case custom export test
    ...
    @issue=SORQA-122 @env_main
    Scenario: Case detailed export and import test
      When API: I create a new person
      Then API: I check that POST call body is "OK"
      And API: I check that POST call status code is 200
      Then API: I create a new case
      ...
      Then I filter by CaseID on Case directory page
      And I click on the Export case button
      Then I click on the Detailed Case Export button
      Then I read exported detailed csv from Case tab